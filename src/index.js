 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight('#c1ffc1', 2, 3)
const ghost2 = new THREE.PointLight('#cd2626', 2, 3)
const ghost3 = new THREE.PointLight('#2f4f4f', 2, 3)
...
const tick = () => {
  ...
  ghost2.position.y = Math.cos(elapsedTime * 4.5) + Math.sin(elapsedTime * 2.5)

  const ghost3Angle = -elapsedTime * 0.2
  ghost3.position.x = Math.cos(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.32))
  ghost3.position.z = Math.sin(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.5))
  ghost3.position.y = Math.cos(elapsedTime * 5.5) + Math.sin(elapsedTime * 1.5)
